    ...
    <section className="space-y-6">
      <div>
        <div className="flex items-center gap-2.5 mb-1">
          ...
          <h1 className="text-sm font-semibold uppercase tracking-widest text-white/70">Bid Sources</h1>
        </div>
        <p className="text-xs text-white/30 ml-[18px]">
          Pipeline de licitaciones por fuente
        </p>
      </div>
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/[0.07] bg-[#0d1745] p-10">
        ...
        <div className="relative flex flex-col items-center text-center space-y-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#E42D2C]/10 ring-1 ring-[#E42D2C]/20">
            <Radio className="h-5 w-5 text-[#E42D2C]" />
          </div>
          <div className="max-w-md space-y-2">
            <h2 className="text-base font-semibold text-white">Próximamente</h2>
            <p className="text-sm text-white/50 leading-relaxed">
              Acá vas a poder ver el rendimiento del pipeline por fuente:
              SAM.gov, portales estatales/locales y outreach directo. Métricas
              tipo opportunities revisadas, bids enviados, win rate y monto
              awardeado. Una vez definidas las fuentes que trackeás, se diseña
              el modelo y se conecta.
            </p>
          </div>
        </div>
      </div>
